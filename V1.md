...
The DigitalOcean V1 API is obsolete. This document is kept only for historical
callers using the legacy `digitalocean.v1.*` namespaces. New code should use
`digitalocean.v2.core` and the current DigitalOcean API v2.
